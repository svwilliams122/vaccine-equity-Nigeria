...
for (i in 1:5) {
  ...
  plot_dat <- switch (i, 
                      ...
                      "5" = plot_data [characteristics == "Antenatal care" |
                                         characteristics == "Birth setting"]
                      )
